 ...
 * Thu Jan 27 2022 11:59:43 GMT+0100 (Central European Standard Time)
    ...
    return (function(cb){
            window.parent.addEventListener('message', function(e){
                if (e.data && e.data.type == 'elfsquad.configurationUpdated'){
                    window['elfsquad.configuration'] = e.data.data;
                    console.log('configuration', window['elfsquad.configuration']);
                    cb();
                }
            });
        }).apply(null, arguments);
...
function elfsquadUpdateRequirementByCode() {
    return (function(featureCode, value) {
            ...
            if (nodeId) {
                console.log('Updating requirement', nodeId, value);
...
elfsquadOnConfigurationUpdate(function() {
  ...
  setObjTransform('mechanism_slider_height', false, 'position', ['', '', elfsquadGetValueByCode('height')], false);
  updateHeight();
});
